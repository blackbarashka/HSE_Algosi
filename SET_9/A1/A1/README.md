## Данные, полученные в результате эмпирических замеров времени работы алгоритмов

Все данные полученные генератором строк и данныем полученные после эмпирических замеров времени находятся в папке `cmake-build-debug` или по [ссылке](https://github.com/blackbarashka/HSE_Algosi/tree/main/SET_9/A1/A1/cmake-build-debug)

---
# Графики и их анализ:
Построение графиков в `grafiks.ipynb`
...
# Сравнение адаптированных и стандартных алгоритмов
На основе проведенного исследования для трех типов наборов строк (неупорядоченных, обратно отсортированных и почти отсортированных) можно сделать следующие выводы:
1.	Превосходство адаптированных алгоритмов:
 -	`STRING QUICKSORT` демонстрирует наилучшую производительность во всех тестах, превосходя стандартные алгоритмы в 5-10 раз по скорости и в 10-30 раз по количеству сравнений.
 -	`MSDRadix` и `MSDRadix_Quick` также стабильно превосходят стандартные алгоритмы, особенно по количеству посимвольных сравнений.
 -	`STRING MERGESORT` показывает смешанные результаты: хорошие на случайных и почти отсортированных данных, но плохие на обратно отсортированных.
2.	Масштабируемость:
 -	На больших массивах (2000-3000 элементов) разница между адаптированными и стандартными алгоритмами становится наиболее выраженной.
 -	При увеличении размера массива разрыв в производительности растет нелинейно, особенно по количеству сравнений.
