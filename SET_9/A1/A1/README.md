...
Все данные полученные генератором строк и данныем полученные после эмпирических замеров времени находятся в папке `cmake-build-debug`[https://github.com/blackbarashka/HSE_Algosi/tree/main/SET_9/A1/A1/cmake-build-debug]
